...
/**
 * Created by Lisa Denzer on 14/04/2017.
 */
public class AssociationRuleGenerator<I> {

    public List<Apriori.AssociationRule<I>>
    mineAssociationRules(FrequentItemsetData<I> data,
        ...
        Set<Apriori.AssociationRule<I>> resultSet = new HashSet<>();
        ...
        for (Set<I> itemset : data.getFrequentItemsetList()) {
            ...
            // item.
            Set<Apriori.AssociationRule<I>> basicAssociationRuleSet =
        ...
        List<Apriori.AssociationRule<I>> ret = new ArrayList<>(resultSet);
    ...
    private void generateAssociationRules(Set<I> itemset,
                                          Set<Apriori.AssociationRule<I>> ruleSet,
                                          FrequentItemsetData<I> data,
                                          double minimumConfidence,
                                          Set<Apriori.AssociationRule<I>> collector) {
        if (ruleSet.isEmpty()) {
            return;
        }
        ...
        // consequent.
        if (k > m + 1) {
            Set<Apriori.AssociationRule<I>> nextRules =
                    moveOneItemToConsequents(itemset, ruleSet, data);

            Iterator<Apriori.AssociationRule<I>> iterator = nextRules.iterator();

            while (iterator.hasNext()) {
                Apriori.AssociationRule<I> rule = iterator.next();
        ...
        for (Apriori.AssociationRule<I> rule : ruleSet) {
            ...
            for (I item : rule.getAntecedent()) {
                ...
                int antecedentSupportCount = data.getSupportCountMap()
                        .get(antecedent);
                Apriori.AssociationRule<I> newRule =
    ...
    generateAllBasicAssociationRules(Set<I> itemset,
        ...
        for (I item : itemset) {
            ...
            basicAssociationRuleSet.add(new Apriori.AssociationRule(antecedent,
                    consequent,
                    confidence));
            antecedent.add(item);
            consequent.remove(item);
