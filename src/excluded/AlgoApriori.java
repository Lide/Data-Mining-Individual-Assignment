...
/**
 * This is an optimized implementation of the excluded.Apriori algorithm that uses binary search to
 ...
 * <br/><br/>
 *
 * The excluded.Apriori algorithm finds all the frequents itemsets and their support in a
...
public class AlgoApriori {
    ...
    public Itemsets runAlgorithm(double minsup, String input, String output) throws IOException {
        ...
        // (excluded.Apriori need to use a total order otherwise it does not work)
